    ...
    list: [
      {
        tag: "样式",
        link: [
          { name: "hover效果", url: "./static/html/1.html" },
          { name: "旋转卡片", url: "./static/html/2.html" },
          { name: "伸缩导航", url: "./static/html/3.html" },
          { name: "输入框", url: "./static/html/4.html" },
          { name: "玻璃图标", url: "./static/html/5.html" },
          { name: "弹性导航", url: "./static/html/6.html" },
          { name: "旋转菜单", url: "./static/html/7.html" },
        ],
      },

      {
        tag: "样式",
        link: [
          { name: "流光按钮", url: "./static/html/8.html" },
          { name: "全屏导航", url: "./static/html/9.html" },
          { name: "菜单悬停", url: "./static/html/10.html" },
          { name: "爱心加载", url: "./static/html/11.html" },
          { name: "小球效果", url: "./static/html/12.html" },
          { name: "发光按钮", url: "./static/html/13.html" },
          { name: "图标悬停", url: "./static/html/14.html" },
        ],
      },
...

      {
        tag: "便捷",
        link: [
          { name: "多邻国", url: "http://www.duolingo.cn/" },
...

      {
        tag: "成绩",
        link: [
          { name: "英语四六级", url: "https://www.chsi.com.cn/cet/" },
          {
            name: "普通话水平",
          ...
          { name: "雅思", url: "http://ielts.etest.edu.cn/" },
    ...
    list: [
...

      {
        ...
        link: [
          ...
          { name: "比一比价", url: "http://www.b1bj.com/" },
        ],
      },
    ],
  },
    ...
    list: [
      {
        ...
        link: [
          ...
          { name: "H5MA", url: "https://www.h5ma.com/" },
...

      {
        ...
        link: [
          ...
          { name: "Bandwagon", url: "https://bandwagonhost.com/" },
        ],
      },
    ],
  },
    ...
    list: [
      {
        ...
        link: [
          ...
          { name: "MyDesy", url: "https://www.mydesy.com/" },
          { name: "ZCOOL", url: "http://www.zcool.com.cn/" },
          { name: "FWA", url: "https://thefwa.com/" },
          { name: "LandBook", url: "https://land-book.com/" },
        ],
      },

      {
        tag: "图库",
        link: [
          { name: "Huaban", url: "http://huabanpro.com/" },
...

      {
        tag: "素材",
        link: [
          { name: "NiPic", url: "http://www.nipic.com/" },
          { name: "58Pic", url: "http://www.58pic.com/" },
          { name: "freepik", url: "https://www.freepik.com/" },
          { name: "UIKit", url: "http://www.uikit.me/" },
          { name: "Pixeden", url: "https://www.pixeden.com/" },
          { name: "Subtlepatterns", url: "http://subtlepatterns.com/" },
          { name: "Fribbble", url: "http://www.fribbble.com/" },
        ],
      },

      {
        tag: "字体",
        link: [
          { name: "Fontsup", url: "https://fontsup.com/" },
          { name: "dafont", url: "https://www.dafont.com/" },
          { name: "Qiuziti", url: "http://www.qiuziti.com/" },
          { name: "MyFonts", url: "https://www.myfonts.com/" },
          { name: "Fonts2u", url: "https://zh.fonts2u.com/" },
          { name: "Fontfabric", url: "http://www.fontfabric.com/" },
          { name: "UrbanFonts", url: "https://www.urbanfonts.com/" },
        ],
      },
